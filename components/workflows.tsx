...
import WorflowImg01 from "@/public/images/category1.png";
import WorflowImg02 from "@/public/images/category2.jpg";
import WorflowImg03 from "@/public/images/category3.jpg";
    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-7 text-center md:pb-7">
            ...
            <p className="text-lg pb-12 text-indigo-200/65">
              ...
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Put your products on our marketplace to reach a wider audience.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Allow our AI Agent Neo create marketing content for your business.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    From marketing posts to banners and photo shoots taylored to your need.
                  </p>
                </div>
              </div>
            </a>
